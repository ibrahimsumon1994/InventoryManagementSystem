<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseReport.aspx.cs" Inherits="SmokeMusicCafe.PurchaseReport" %>
...
<body style="background-image: url(picture1/background.jpeg); background-repeat: no-repeat; background-size: cover">
    ...
    <form id="form1" runat="server">
        <div class="container-fluid">
            <asp:Label ID="lblHeadingPage" runat="server" Text="Report Page Of Purchase Information" class="badge badge-primary" style="width:100%; height:30px; font-size:large; margin:10px; margin-left:0px"></asp:Label>
        ...
        <div class="container-fluid" style="width: 100%; height: 400px; overflow: auto">
            ...
            <asp:GridView ID="gvPurchaseReport" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="purchaseID" ShowHeaderWhenEmpty="true" Width="100%"
                OnRowCancelingEdit="gvPurchaseReport_RowCancelingEdit" OnRowDeleting="gvPurchaseReport_RowDeleting" OnRowEditing="gvPurchaseReport_RowEditing" OnRowUpdating="gvPurchaseReport_RowUpdating"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Total Amount">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtTotalAmount" Text='<%#Eval("total_amount", "{0:N2}") %>' runat="server"></asp:TextBox>
                        </EditItemTemplate>
                    </asp:TemplateField>
        ...
        <script>
            function doPrint() {
                var prtContent = document.getElementById('<%= gvPurchaseReport.ClientID %>');
                ...
                var heading = "<div style=' text-align: center; width:100%'><h3>Purchasing Record's</h3></div>";
