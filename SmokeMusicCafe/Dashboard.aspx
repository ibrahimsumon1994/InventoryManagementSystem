...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="btnExpenditureReport" class="btn btn-outline-success" style="float: right; margin-right: 50px; margin-top:60px; width:230px; height:70px" runat="server" Text="Expenditure Report" PostBackUrl="ExpenditureReport.aspx"></asp:Button>
    <asp:Button ID="btnDailySalesReport" class="btn btn-outline-success" style="float: right; margin-right: 50px; margin-top:60px; width:230px; height:70px" runat="server" Text="Daily Sales Report" PostBackUrl="DailySalesReport.aspx"></asp:Button>
    <asp:Button ID="btnProfit" class="btn btn-outline-success" style="float: right; margin-right: 50px; margin-top:60px; width:230px; height:70px" runat="server" Text="Profit" PostBackUrl="Profit.aspx"></asp:Button>
    <br />
    <br />
