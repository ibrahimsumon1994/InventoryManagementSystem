<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailySalesReport.aspx.cs" Inherits="SmokeMusicCafe.DailySalesReport" %>
...
<body style="background-image:url(picture1/background.jpeg); background-repeat: no-repeat; background-size:cover">
    ...
    <form id="form1" runat="server">
        <div class="container-fluid">
            <asp:Label ID="lblHeadingPage" runat="server" Text="Report Page Of Daily/Monthly Sales" class="badge badge-primary" style="width:100%; height:30px; font-size:large; margin:10px; margin-left:0px"></asp:Label>
        ...
        <div>
            ...
            <div class="container-fluid" style="overflow: auto; float:left; width:100%; height:300px">
                <asp:GridView ID="gvDailySalesReport" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="daily_sales_date" ShowHeaderWhenEmpty="true" Width="100%"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Date">
                            <ItemTemplate>
                                <asp:Label Text='<%#Eval("daily_sales_date") %>' runat="server"></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="txtSalesDate" class="date" Text='<%#Eval("daily_sales_date") %>' runat="server"></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Sales Amount(Taka)">
                            <ItemTemplate>
