...
<body style="background-image:url(picture1/background.jpeg); background-repeat: no-repeat; background-size:cover">
    ...
    <form id="form1" runat="server">        
        <div class="container-fluid" style="width:100%; height:auto">
            <asp:Label ID="lblHeadingPage" runat="server" Text="Input Page Of Other Cost" class="badge badge-primary" style="width:100%; height:30px; font-size:large; margin:10px; margin-left:0px"></asp:Label>
            <ul style="list-style-type:none;">
                <li>
                    ...
                    <asp:Button ID="btnMonthlyFixedCostReport" class="btn btn-outline-success" style="float: right; margin-right: 100px; margin-top:60px; width:230px; height:70px" runat="server" Text="Other Cost Report" PostBackUrl="FixedCostReport.aspx"></asp:Button>
                    <asp:Button ID="btnOtherList" class="btn btn-outline-success" style="float: right; margin-right: 100px; margin-top:60px; width:230px; height:70px" runat="server" Text="List of Other Cost" PostBackUrl="ListOfOtherCost.aspx"></asp:Button>
                </li>
                <li>
                ...
                <li>
                    ...
                    <asp:Label ID="errorName" Text="" runat="server" ForeColor="red" />
                ...
                <li>
                    ...
                    <asp:Label ID="lblRemark" runat="server" Text="Remark" class="badge badge-primary" style="width:200px; height:30px; font-size:large; margin:10px; margin-left:87px" Visible="false"></asp:Label>
                ...
                <li>
                    ...
                    <asp:Label ID="lblChequeNo" runat="server" Text="Cheque Number" class="badge badge-primary" style="width:200px; height:30px; font-size:large; margin:10px; margin-left: 40px" Visible="false"></asp:Label>
