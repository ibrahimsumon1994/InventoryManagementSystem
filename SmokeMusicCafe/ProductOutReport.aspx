...
<body style="background-image:url(picture1/background.jpeg); background-repeat: no-repeat; background-size:cover">
    ...
    <form id="form1" runat="server">
        <div class="container-fluid">
            <asp:Label ID="lblHeadingPage" runat="server" Text="Report Page Of Product Out" class="badge badge-primary" style="width:100%; height:30px; font-size:large; margin:10px; margin-left:0px"></asp:Label>
        ...
        <div class="container-fluid" style="width:100%; height:500px; overflow:auto">
            ...
            <asp:GridView ID="gvProductOutReport" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="productOutID" ShowHeaderWhenEmpty="true" Width="100%"
                OnRowCancelingEdit="gvProductOutReport_RowCancelingEdit" OnRowDeleting="gvProductOutReport_RowDeleting" OnRowEditing="gvProductOutReport_RowEditing" OnRowUpdating="gvProductOutReport_RowUpdating"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Product Out Date">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtProductOutDate" class="date" Text='<%#Eval("productOut_date") %>' runat="server"></asp:TextBox>
                        </EditItemTemplate>
                    </asp:TemplateField>
