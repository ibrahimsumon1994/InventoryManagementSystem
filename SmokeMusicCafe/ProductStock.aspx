...
<body style="background-image: url(picture1/background.jpeg); background-repeat: no-repeat; background-size: cover">
    ...
    <form id="form1" runat="server">
        <div class="container-fluid" style="width: 100%; height: auto">
            <asp:Label ID="lblHeadingPage" runat="server" Text="Page Of Stock Product" class="badge badge-primary" Style="width: 100%; height: 30px; font-size: large; margin: 10px; margin-left: 0px"></asp:Label>
            ...
            <div id="visibleDiv" runat="server" class="container-fluid" style="width: 40%; height: auto; float: left">
                <div class="container-fluid" style="width: 100%; height: auto">
                    <ul style="list-style-type: none;">
                        ...
                        <li>
                            <asp:Label ID="lblName" runat="server" Text="Product Name" class="badge badge-primary" Style="width: 200px; height: 30px; font-size: large; margin: 10px; margin-left: 0px"></asp:Label>
                ...
                <br />
                <div style="text-align: center; margin-right: auto; margin-left: auto">
                    <asp:Label ID="lblProductList" Text="Product List" runat="server" ForeColor="Red" />
                </div>
                <div class="container-fluid" style="width: 100%; height: 300px; overflow: auto">

                    <asp:GridView ID="gvProductName" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="id" ShowHeaderWhenEmpty="true" Width="100%"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Items Name">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtItemName" Text='<%#Eval("item_name") %>' runat="server" AutoCompleteType="Disabled"></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
