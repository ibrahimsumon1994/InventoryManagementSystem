    ...
    <form id="form1" runat="server">
        <div class="container-fluid">
            ...
            <div style="width: 50%; height: 250px; float: left">
                <ul style="list-style-type: none;">
                    <li>
                        <asp:Button ID="btnPrint" class="btn btn-outline-success" style="width:120px; float:right" runat="server" Text="Print" OnClientClick="doPrint()"></asp:Button>
                        <asp:Button ID="btnDownload" class="btn btn-outline-success" style="width:120px; float:right" runat="server" Text="Download" OnClick="btnExportToPDF_Click"></asp:Button>
                    </li>
                    <li>
                    ...
                    <li>
                        <asp:Label ID="lblEndDateByProduct" runat="server" Text="Start Date" class="badge badge-primary" Style="width: 200px; height: 30px; font-size: large; margin: 10px; margin-left: 0px"></asp:Label>
                ...
                <%--<asp:Label ID="lblStartDateProduct" Text="" runat="server" ForeColor="Green" />
                <asp:Label ID="lblTo" Text="" runat="server" style="margin-left:10px" ForeColor="Green" />
                <asp:Label ID="lblEndDateProduct" Text="" runat="server" style="margin-left:10px" ForeColor="Green" />
                <br />
                <asp:Label ID="lblProductNameShow" Text="" runat="server" ForeColor="Green" />
                <br />
                <asp:Label ID="lblTotalAmount" Text="" runat="server" ForeColor="Green" />--%>
            </div>
        </div>
        <div>
                ...
                <asp:GridView ID="gvExpenditureReport" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="daily_expense_date" ShowHeaderWhenEmpty="true" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Expenditure(Taka)">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtTotalAmount" Text='<%#Eval("amount") %>' runat="server"></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
