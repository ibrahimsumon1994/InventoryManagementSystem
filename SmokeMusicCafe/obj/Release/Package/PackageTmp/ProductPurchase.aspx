        ...
        <div class="container-fluid" style="width:100%; height:auto">
            <ul style="list-style-type:none;">
                <li>
                    ...
                    <asp:Button ID="btnPurchaseReport" class="btn btn-outline-success" style="float: right; margin-right: 100px; margin-top:60px; width:230px; height:70px" runat="server" Text="Purchase Report" PostBackUrl="PurchaseReport.aspx"></asp:Button>
                    <asp:Button ID="btnMonthlyFixedCost" class="btn btn-outline-success" style="float: right; margin-right: 100px; margin-top:60px; width:230px; height:70px" runat="server" Text="Monthly Fixed Cost" PostBackUrl="MonthlyFixedCost.aspx"></asp:Button>
                </li>
                <li>
                ...
                <li>
                    ...
                    <asp:Label ID="lblRemark" runat="server" Text="Remark" class="badge badge-primary" style="width:200px; height:30px; font-size:large; margin:10px" Enabled="false"></asp:Label>
            ...
            <asp:GridView ID="gvPurchase" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="purchaseID" ShowHeaderWhenEmpty="true" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Total Amount">
                        <ItemTemplate>
                            <asp:Label Text='<%#Eval("total_amount") %>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtTotalAmount" Text='<%#Eval("total_amount") %>' runat="server"></asp:TextBox>
                        </EditItemTemplate>
                    </asp:TemplateField>
